...
TEXT=examples/translation_decoupled_vocab/$EXPERIMENT_NAME.de-en
fairseq-preprocess --source-lang de --target-lang en \
    --trainpref $TEXT/train --validpref $TEXT/valid --testpref $TEXT/test \
    --destdir examples/translation_decoupled_vocab/data-bin/iwslt14.tokenized.de-en \
    --workers 20
```
...
CUDA_VISIBLE_DEVICES=0; nohup fairseq-train \
    ...
    --save-dir 0607_decoupled_vocab_checkpoints &
```
